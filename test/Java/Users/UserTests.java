...
public class UserTests {
    ...
    @BeforeEach
    void setRequest() {
        request = given().config(RestAsssured.config().logConfig(logConfig().enableLoggingOfRequestAndResponseIfValidationFails.
        ()))
    ...
    @Test
    @Order(1)
    public void CreatNewUser_WithValidData_ReturnOk() {
    ...
    @Test
    public void CreatNewUser_WithInvalidBody_ReturnBadRequest() {
